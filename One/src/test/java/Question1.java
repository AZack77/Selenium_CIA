...
public class Question1
{
    public static void main( String[] args ) throws InterruptedException
    {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id=\"ap_email\"]")).sendKeys("9894722476");
        driver.findElement(By.xpath("//*[@id=\"continue\"]")).click();
        driver.findElement(By.xpath("//*[@id=\"ap_password\"]")).sendKeys("Arwin123@#$");
        driver.findElement(By.xpath("//*[@id=\"signInSubmit\"]")).click();
        WebElement price = driver.findElement(By.xpath("//*[@id=\"subtotals-marketplace-table\"]/tbody/tr[4]/td[2]"));
